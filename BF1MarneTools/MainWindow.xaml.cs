...
public partial class MainWindow
{
    ...
    private void Window_Main_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        if (Directory.Exists(Globals.BF1InstallDir))
            ResHelper.ExtractResFile("Data.dinput8.dll", Path.Combine(Globals.BF1InstallDir, "dinput8.dll"));

        // 初始化工作
        Ready.Run();

        // 注册 RunBf1Game 启动游戏事件
        WeakReferenceMessenger.Default.Register<string, string>(this, "RunBf1Game", (s, e) =>
        {
