...
public static class Globals
{
    ...
    {
        get { return ReadString("Language", "LocaleID"); }
        set { WriteString("Language", "LocaleID", value); }
    }
    ...
    static Globals()
    {
        ...
        // 如果此节点为空，则默认为简体中文
        if (IniHelper.IsKeyEmpty("Language", "LocaleID", _iniPath))
            LocaleID = Chinese;
    ...
    {
        LoggerHelper.Info(Lang.Globals_ReadConfig);
        ...
        if (CoreUtil.IsBf1MainAppFile(appPath))
        {
            ...
            LoggerHelper.Info($"{Lang.Globals_BF1PathFind} {BF1AppPath}");
        }
        else
        {
            SetBF1AppPath(string.Empty);
            LoggerHelper.Warn(Lang.Globals_BF1PathNotFind);
        }
        ...
        LoggerHelper.Info(Lang.Globals_ReadConfigSuccess);
    }
    ...
    {
        LoggerHelper.Info(Lang.Globals_SaveConfig);
        ...
        LoggerHelper.Info(Lang.Globals_SaveConfigSuccess);
    }
