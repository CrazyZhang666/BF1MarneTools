...
public partial class SettingWindow
{
    ...
    private void Window_Setting_ContentRendered(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                // 直接从资源文件提取到本地
                ResHelper.ExtractResFile("Docs.ServerSettings.txt", SettingsFilePath);
            }
    ...
    {
        TextBox_ServerSettings.Text = ResHelper.GetEmbeddedResourceText("Docs.ServerSettings.txt");
    }
