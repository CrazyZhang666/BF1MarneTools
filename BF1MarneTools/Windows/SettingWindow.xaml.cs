...
public partial class SettingWindow
{
    ...
    private void Window_Setting_ContentRendered(object sender, EventArgs e)
    {
        ...
        {
            LoggerHelper.Error($"{Lang.SettingWin_InitSettingException}  {ex.Message}");
        }
    }
    ...
    private void ReadSettingFile()
    {
        try
        {
            ...
            LoggerHelper.Info(Lang.SettingWin_ReadSettingSuccess);
        }
        catch (Exception ex)
        {
            LoggerHelper.Error($"{Lang.SettingWin_ReadSettingException}  {ex.Message}");
        }
    }
    ...
    private void SaveSettingFile()
    {
        try
        {
            ...
            LoggerHelper.Info(Lang.SettingWin_SaveSettingSuccess);
            LoggerHelper.Info($"{Lang.SettingWin_SettingPath} {SettingsFilePath}");
        }
        catch (Exception ex)
        {
            LoggerHelper.Error($"{Lang.SettingWin_SaveSettingException}  {ex.Message}");
        }
