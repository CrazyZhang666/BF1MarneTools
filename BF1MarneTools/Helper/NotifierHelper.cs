...
public static class NotifierHelper
{
    ...
    static NotifierHelper()
    {
        ...
        NotificationConstants.DefaultForegroundColor = (Brush)new BrushConverter().ConvertFrom("#DFE1E5");
    ...
    private static void Show(NotificationType type, string message)
    {
        Application.Current.Dispatcher.Invoke(() =>
        {
            var title = type switch
            {
                ...
                NotificationType.Information => Lang.NotifierHelper_Information,
                NotificationType.Success => Lang.NotifierHelper_Success,
                NotificationType.Warning => Lang.NotifierHelper_Warning,
                NotificationType.Error => Lang.NotifierHelper_Error,
                NotificationType.Notification => Lang.NotifierHelper_Notification,
                _ => "",
            };
