...
public static class FileHelper
{
    ...
    public static void ClearDirectory(string dirPath)
    {
        try
        {
            ...
            LoggerHelper.Info($"{Lang.FileHelper_ClearDirectorySuccess} {dirPath}");
        }
        catch (Exception ex)
        {
            LoggerHelper.Error($"{Lang.FileHelper_ClearDirectoryException} {dirPath}", ex);
        }
    }
    ...
    public static void ExtractResFile(string resPath, string outputPath, bool isOverride = true)
    {
        ...
        try
        {
            ...
            LoggerHelper.Info($"{Lang.FileHelper_ExtractResFileSuccess} {outputPath}");
        }
        catch (Exception ex)
        {
            LoggerHelper.Error($"{Lang.FileHelper_ExtractResFileException} {outputPath}", ex);
        }
        finally
        {
            outStream?.Close();
