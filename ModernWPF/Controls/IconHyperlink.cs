...
public class IconHyperlink : Control
{
    ...
    public static readonly DependencyProperty IconProperty = DependencyProperty.Register(
        nameof(Icon), typeof(string), typeof(IconHyperlink), new PropertyMetadata(default));
    ...
    public static readonly DependencyProperty TextProperty = DependencyProperty.Register(
        nameof(Text), typeof(string), typeof(IconHyperlink), new PropertyMetadata(default));
    ...
    public static readonly DependencyProperty UriProperty = DependencyProperty.Register(
        nameof(Uri), typeof(Uri), typeof(IconHyperlink), new PropertyMetadata(default));
